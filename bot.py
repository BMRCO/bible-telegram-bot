...
def generate_hook_ai(verse_text, ref, cat_name):
    ...
    try:
        ...
        prompt = (
            ...
            "- NE NOMME LE PUBLIC QUE SI LE TEXTE LE NOMME SIMPLEMENT (Paul, "
            "la foule, ses disciples). Quand le chapitre le designe par une "
            "formule composee — Luc 24:33 dit « les onze, et ceux qui etaient "
            "avec eux » — NE LE MENTIONNE PAS DU TOUT. Le remplacer par une "
            "categorie connue (« les apotres ») est une erreur de fait ; le "
            "recopier tel quel alourdit la phrase au point qu'elle ne donne "
            "plus envie de lire. Dans ce cas, parle de ce que le passage "
            "AFFIRME : il y a toujours mieux a dire que l'auditoire.\n"
